...
if ($payload && $event_type === 'invoice') {
    ...
    if ($inv_odoo_id && $inv_event === 'delete') {
        ...
        // NOTE: Auto add/sync invoice → debts đã bị TẮT.
        // Debt giờ chỉ được tạo thủ công qua trang /invoice ("add to debts").
        // (Vẫn giữ phần xóa debt ở trên khi invoice cancel/Internal để tránh debt rác.)
