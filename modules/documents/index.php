...
function sanitize_filename($filename) {
    ...
    // Replace EVERYTHING that is not a-z, 0-9, dash or underscore with underscore
                            ...
                            ?>
                                <div class="doc-card" style="padding: 20px;">
                                    ...
                                    <div style="display: flex; gap: 8px; margin-top: 20px;">
                                        ...
                                        <a href="<?= $row['file_path'] ?>" download class="btn-apple-sec" style="width: 36px; height: 36px; padding: 0; flex-shrink: 0; border-radius: 10px;" title="Tải xuống">
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                                        </a>
                                        <a href="<?= $row['file_path'] ?>" target="_blank" class="btn-apple-sec" style="width: 36px; height: 36px; padding: 0; flex-shrink: 0; border-radius: 10px;" title="Mở tab mới">
                            ...
                            ?>
                                <div class="doc-list-item">
                                    ...
                                    <div style="width:120px; display:flex; justify-content:flex-end; gap:8px;">
                                        ...
                                        <a href="<?= $row['file_path'] ?>" download class="view-btn" style="padding:6px;" title="Tải xuống"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg></a>
                                        <a href="<?= $row['file_path'] ?>" target="_blank" class="view-btn" style="padding:6px;" title="Mở tab mới"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg></a>
                                        <?php if($role === 'admin'): ?>
