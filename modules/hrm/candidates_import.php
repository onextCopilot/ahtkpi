...
$fields = [
    ...
    'owner'            => ['Phụ trách (Base để ở cột Thẻ)', ['phụ trách','người phụ trách','phu trach','owner','assignee','recruiter','thẻ','tag']],
    ...
    'applied_time'     => ['Thời gian ứng tuyển', ['thời gian ứng tuyển']],
    'interview_date'   => ['Thời gian phỏng vấn', ['thời gian phỏng vấn','lịch phỏng vấn','interview time']],
    'offer_date'       => ['Ngày đề nghị', ['ngày đề nghị','offer date']],
    'offer_time'       => ['Giờ đề nghị', ['giờ đề nghị','offer time']],
    'hired_date'       => ['Ngày tuyển', ['ngày tuyển','hired date','hire date']],
    'hired_time'       => ['Giờ tuyển', ['giờ tuyển','hired time']],
    'reject_date'      => ['Reject Date', ['reject date','ngày từ chối']],
    'reject_time'      => ['Giờ từ chối', ['giờ từ chối','reject time']],
    'office_text'      => ['Văn phòng', ['văn phòng','office']],
    'reject_reason'    => ['Lý do từ chối', ['lý do từ chối','reject reason']],
    'reject_note'      => ['Thông tin từ chối', ['thông tin từ chối','reject info','reject note']],
    'rejected_by'      => ['Từ chối bởi (→ user)', ['từ chối bởi','rejected by','reject by']],
